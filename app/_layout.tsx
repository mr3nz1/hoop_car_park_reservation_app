        ...
        >
          ...
          <Stack.Screen
            ...
            options={{
              header: ({ navigation }) => {
                return (
                  <NavigationHeader title="Details" navigation={navigation} />
                );
              },
            }}
          />
          ...
          <Stack.Screen
            ...
            options={{
              header: ({ navigation }) => {
                return (
                  <NavigationHeader title="Payment" navigation={navigation} />
                );
              },
            }}
          />
          ...
          <Stack.Screen
            ...
            options={{
              header: ({ navigation }) => {
                return (
                  <NavigationHeader title="Booking" navigation={navigation} />
                );
              },
            }}
          />
          ...
          <Stack.Screen
            ...
            options={{
              header: ({ navigation }) => {
                return (
                  <NavigationHeader title="Explore" navigation={navigation} />
                );
              },
            }}
          />
          <Stack.Screen
            ...
            options={{
              header: ({ navigation }) => {
                return (
                  <NavigationHeader title="History" navigation={navigation} />
                );
              },
            }}
          />
